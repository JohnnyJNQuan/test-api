...
public class ExceptionController {
	...
	public ResponseEntity<Object> notFoundException(ItemNotFoundException exception) {
		ToDoItemNotFoundErrorDetails[] toDoItemNotFoundErrorDetailsArray = new ToDoItemNotFoundErrorDetails[1];
		ToDoItemNotFoundErrorDetails toDoItemNotFoundErrorDetails = new ToDoItemNotFoundErrorDetails();
	...
	public ResponseEntity<Object> validatErrorException(ValidationErrorException exception) {
		ToDoItemValidationErrorDetails[] toDoItemValidationErrorDetailssArray = new ToDoItemValidationErrorDetails[1];
		ToDoItemValidationErrorDetails toDoItemValidationErrorDetails = new ToDoItemValidationErrorDetails();
	...
	public ResponseEntity<Object> balancedInputValidationErrorException(
			BalancedInputValidationErrorException exception) {
		ToDoItemValidationErrorDetails[] validationErrorDetailssArray = new ToDoItemValidationErrorDetails[1];
		ToDoItemValidationErrorDetails validationErrorDetails = new ToDoItemValidationErrorDetails();
